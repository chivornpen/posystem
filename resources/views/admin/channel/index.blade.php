    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: #117A65; color: white;">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h3 class="modal-title" id="exampleModalLabel"><i class="fa fa-area-chart" aria-hidden="true"></i> New Channel</h3>
          </div>
...
<div class="row">
    <div class="col-lg-12">                
        <h4 class="page-header"><i class="fa fa-area-chart" aria-hidden="true"></i> Channels</h4>
    </div>
</div>
<div>
  @include('nav.message')
...
                <td style="font-size: 11px; font-family: 'Khmer OS System';">
                ...
                <td style="text-align: center;">
                    <a href="{{ route('channels.edit',$channel->id)}}" class="btn btn-warning btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
                    <form action="{{ route('channels.destroy', $channel->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Are you sure you want to delete?')) { return true } else {return false };">
