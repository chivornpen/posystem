...
<div class="row">
    <div class="col-lg-12">                
        <h4 class="page-header"><i class="fa fa-building-o" aria-hidden="true"></i> Edit Supplier </h4>
    </div>
               <!-- /.col-lg-12 -->
</div>
<div>
  @include('nav.message')
    ...
    <div class="row">
      <div class="col-lg-12">
        {!!Form::model($supplier,['action'=>['SupplierController@update',$supplier->id],'method'=>'PATCH'])!!}
          {{csrf_field()}}
             <div class="row">
                <div class="col-lg-12">
