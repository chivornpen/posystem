    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body table-responsive">
                {!! Form::open(['action'=>'ExchangesdController@store','method'=>'POST'])!!}
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <select name="invN" id="invN" class="form-control" onchange="InvoiceView()">
                                    <option value="0">Please select</option>
                                    @foreach( $stockoutsd as $invN)
    ...
    <script type="text/javascript">
        ...
        function InvoiceView()
        {
            var InvN = $("#invN").val();
                $.ajax({
                    type: 'get',
                    url: "{{url('/showProductExchangeSd')}}"+"/"+InvN,
                    dataType: 'html',
        ...
        function SaveRecord() {
            ...
            if(err==""){
                $.ajax({
                    type: 'get',
                    url: "{{url('/saveExchangesd')}}"+"/"+impId+"/"+proId+"/"+qty+"/"+exp+"/"+stId,
                    dataType: 'html',
                    success:function (data) {
                        $("#viewInvoice").html(data);
                        $(document).ready(function() {
